...
class FilterDataset(Dataset):
    ...
    def _build_random_masked_tokens_and_labels(self, tokens, sim):
        ...
        #     std_prob = np.std(valid_prob)
            
        #     normed_prob = (valid_prob - mean_prob) / std_prob

        #     target_prob_mean = 0.15
        #     target_prob_std = std_prob
        #     # factor = target_prob_mean / mean_prob
        #     normalized_prob = normed_prob * target_prob_std + target_prob_mean
